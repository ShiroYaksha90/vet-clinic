...
JOIN owners ON owners.id = animals.owner_id GROUP BY owners.full_name ORDER BY count DESC LIMIT 1;/*Queries that provide answers to the questions from all projects.*/
